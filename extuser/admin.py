...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('login_name', 'email', 'last_name', 'first_name', 'display_name', 'is_admin')
    list_filter = ('is_admin',)
    fieldsets = (
        (None, {'fields': ('login_name', 'password')}),
        ('Personal info', {'fields': ('email', 'last_name', 'first_name', 'display_name', 'title', 'departament',)}),
